...
const POST_TITLE = 'ProGAN: Generating High Resolution Images';
    ...
    return (
        <div className="min-h-screen bg-brand-dark text-zinc-300 selection:bg-brand-gold/30 selection:text-white">
            <SEO
                ...
                description="Exploring Progressive GANs and how they stabilize training to generate stunning high-resolution images."
            />
            <CustomCursor />
            <Background />
            <Navbar />
