...
const POST_TITLE = 'Mastering TensorBoard with PyTorch';
    ...
    return (
        <div className="min-h-screen bg-brand-dark text-zinc-300 selection:bg-brand-gold/30 selection:text-white">
            <SEO
                ...
                description="A hands-on guide to using TensorBoard for visualizing data and model training with the Fashion-MNIST dataset."
            />
            <CustomCursor />
            <Background />
            <Navbar />
